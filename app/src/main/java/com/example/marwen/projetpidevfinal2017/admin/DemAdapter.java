...
public class DemAdapter  extends BaseAdapter implements Filterable {
    ...
    public DemAdapter(Activity activity, List<Matdispo> movieItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.row_dem, null);

        //  imageLoader = AppController.getInstance().getImageLoader();
        TextView nom = (TextView) convertView.findViewById(R.id.nom_dem);
        TextView categorie = (TextView) convertView.findViewById(R.id.cat_dem);
        ImageView im = (ImageView) convertView.findViewById(R.id.im_dem);
